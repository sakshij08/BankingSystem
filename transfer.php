    ...
    <div class="container" style=" padding-top:200px;"  >
          <div class="row" >
             <div class="col-sm offset-md-3 col-md-6" style="">
                  <div class="panel panel-default bg-dark  " style="padding: 10px; color:white; border-radius: 20px;background-color: #18bc9c;">
            ...
            <p><button class="btn btn-dark btn-lg view_data" data-toggle="modal" data-target="#transfer<?php echo $row['id'] ?>">Transfer Credits</button></p> 
                                   </div>
                                </div>
            </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="form-group row">
                          <button href="profile.php?id=$id" type="submit" id="submit" name="submit" class="btn btn-primary btn-m ml-auto" style="margin-left: 20px">Transfer</button>  
